...
const PageFooter = () => {
    return(
        <footer className="bg-white  shadow dark:bg-gradient-to-r from-blue-800 to-indigo-900 ">
    <div className=" grid w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <Image
                ...
                height={140} 
            />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">E-commerce store</span>
            </a>
